 ...
 *
 * Usage: JavaKinesisWordCountASLYARN <stream-name> <endpoint-url>
 ...
 */
public final class JavaKinesisWordCountASLYARN { // needs to be public for access from run-example
    private static final Pattern WORD_SEPARATOR = Pattern.compile(" ");
    private static final Logger logger = Logger.getLogger(JavaKinesisWordCountASLYARN.class);

    /* Make the constructor private to enforce singleton */
    private JavaKinesisWordCountASLYARN() {
    }
    ...
    public static void main(String[] args) {
        ...
        SparkConf sparkConfig = new SparkConf().setAppName("KinesisWordCount").setMaster("yarn-cluster");
